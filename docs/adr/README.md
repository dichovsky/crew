...
| [0014](./0014-worker-context-clear-signoff.md) | accepted | a Worker's context is safe to clear only after a Sign-off confirms its Task has fully landed, never right after a Submission; the Sign-off's mechanics are amended by ADR-0016 |
